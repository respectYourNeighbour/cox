module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            tasks: ['newer:less', 'newer:concat', 'newer:htmlmin', 'newer:uglify', 'newer:merge-json', 'newer:jsonmin', 'cssmin'],
            livereload: {
    ...
    grunt.registerTask('default', ['newer:less', 'newer:concat', 'newer:htmlmin', 'newer:uglify', 'newer:merge-json', 'newer:jsonmin', 'cssmin']);
...
7. "cssmin"           -> Minifying the tidy CSS file; 
